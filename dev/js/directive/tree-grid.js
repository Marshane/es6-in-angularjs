    ...
    .run([
      ...
      function ($templateCache) {
        $templateCache.put('template/treeGrid/treeGrid.html',
          ...
          "       <td><a style=\"float: left;\" ng-click=\"user_clicks_branch(row.branch)\"><i ng-class=\"row.tree_icon\"\n" +
          "              ng-click=\"row.branch.expanded = !row.branch.expanded\"\n" +
          "              class=\"indented tree-icon\"></i></a><span style=\"float: left; width:90%; margin:-1px 0 0 4px;\" class=\"indented tree-label\" ng-click=\"on_user_click(row.branch)\">\n" +
          "             {{row.branch[expandingProperty.field] || row.branch[expandingProperty]}}</span>\n" +
          "       </td>\n" +
          "       <td ng-class=\"col.className\" ng-repeat=\"col in colDefinitions\">\n" +
      ...
      function ($timeout,
        ...
        return {
          ...
          link       : function (scope, element, attrs) {
            ...
            var enumProperty = scope.enumProperty;
            error = function (s) {
              console.log('ERROR:' + s);
              debugger;
              return void 0;
            ...
            if (!attrs.colDefs) {
              if (scope.treeData.length) {
                var _col_defs = [],
                  ...
                  _unwantedColumn = [enumProperty, 'level', 'expanded', expandingProperty];
            ...
            for_each_branch = function (f) {
              ...
              do_f = function (branch, level) {
                ...
                f(branch, level);
                if (branch[enumProperty] != null) {
                  _ref = branch[enumProperty];
                  _results = [];
            ...
            var sort_recursive = function(elements, col, descending) {
              ...
              for (var i = 0; i < elements.length; i++) {
                  sort_recursive(elements[i][enumProperty], col, descending);
              }
            };
            ...
            on_treeData_change = function () {
              ...
              for_each_branch(function (b) {
                var child, _i, _len, _ref, _results;
                if (angular.isArray(b[enumProperty])) {
                  _ref = b[enumProperty];
                  _results = [];
                  for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                    child = _ref[_i];
              ...
              for_each_branch(function (branch) {
                var child, f;
                if (branch[enumProperty]) {
                  if (branch[enumProperty].length > 0) {
                    f = function (e) {
                      if (typeof e === 'string') {
                          var __obj = {
                              label   : e
                    ...
                    return branch[enumProperty] = (function () {
              ...
              add_branch_to_list = function (level, branch, visible) {
                ...
                if (!branch[enumProperty] || branch[enumProperty].length === 0) {
            ...
            if (scope.treeControl != null) {
              if (angular.isObject(scope.treeControl)) {
                ...
                tree.add_branch = function (parent, new_branch) {
                  if (parent != null) {
                    parent[enumProperty].push(new_branch);
                ...
                tree.get_first_child = function (b) {
                  ...
                  if (b != null) {
                    if (((_ref = b[enumProperty]) != null ? _ref.length : void 0) > 0) {
                      return b[enumProperty][0];
                    }
                  }
                };
                ...
                tree.last_descendant = function (b) {
                  ...
                  n = b[enumProperty].length;
                  if (n === 0) {
                    return b;
                  } else {
                    last_child = b[enumProperty][n - 1];
